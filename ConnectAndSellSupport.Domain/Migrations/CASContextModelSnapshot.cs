...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConnectAndSellSupport.Domain.Models.CasCompanySetting", b =>
                {
                    ...
                    b.ToTable("cas_CompanySetting");
                });

            modelBuilder.Entity("ConnectAndSellSupport.Domain.Models.CasCompanySettingDetail", b =>
                {
                    ...
                    b.Property<string>("ModifiedSettingValue")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PreviousSettingValue")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("cas_CompanySetting_Details");
                });
            modelBuilder.Entity("ConnectAndSellSupport.Domain.Models.CasMasterJob", b =>
            {
            ...
            modelBuilder.Entity("ConnectAndSellSupport.Domain.Models.CasJobsTriggeredDetails", b =>
            {
                b.Property<int>("Id")
                       .ValueGeneratedOnAdd()
                       .HasColumnType("int")
          ...
          modelBuilder.Entity("ConnectAndSellSupport.Domain.Models.CasContact", b =>
            ...
            modelBuilder.Entity("ConnectAndSellSupport.Domain.Models.CasListContact", b =>
                {
                    b.Property<int>("ListId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "ContactId" }, "contactid_listid_idx");

                    b.HasIndex(new[] { "ContactId" }, "ix_cas_ListContact_ContactId");

                    b.ToTable("cas_ListContact");
                });
            ...
            modelBuilder.Entity("ConnectAndSellSupport.Domain.Models.TCountryInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("DomesticFormat")
                        .HasMaxLength(100)
                        .IsUnicode(false)
                        .HasColumnType("varchar(100)");

                    b.Property<string>("IddCode")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                        .HasColumnType("varchar(10)");

                    b.Property<string>("IntlFormat")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(100)
                        .IsUnicode(false)
                        .HasColumnType("varchar(100)")
                    ...
                    b.Property<string>("NddCode")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                        .HasColumnType("varchar(10)");

                    b.Property<bool?>("NoCountryCode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity("ConnectAndSellSupport.Domain.Models.CasJobsTriggeredDetails", b =>
            {
                b.HasOne("ConnectAndSellSupport.Domain.Models.CasMasterJob", "MasterJob")
                    .WithMany("CasMasterJob")
                    .HasForeignKey("UserId")
                    .HasConstraintName("FK_Cas_JobsTriggeredDetails_Cas_MasterJob")
                    .IsRequired();

                b.Navigation("MasterJob");
            });
            ...
            modelBuilder.Entity("ConnectAndSellSupport.Domain.Models.CasListContact", b =>
                {
                    b.HasOne("ConnectAndSellSupport.Domain.Models.CasContact", "Contact")
                        .WithMany("CasListContacts")
                        .HasForeignKey("ContactId")
                        .HasConstraintName("FK_cas_ListContact_cas_Contact")
                        .IsRequired();

                    b.HasOne("ConnectAndSellSupport.Domain.Models.CasList", "List")
                        .WithMany("CasListContacts")
            ...
            modelBuilder.Entity("ConnectAndSellSupport.Domain.Models.TCompany", b =>
                {
                    ...
                    b.Navigation("CasCompanySettings");
