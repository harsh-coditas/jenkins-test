...
{
    public class PitcherConversionRecordResponse
    {
        ...
        [JsonPropertyName("pitcher_record_found")]
        public bool PitcherRecordFound { get; set; }

        [JsonPropertyName("note_record_found")]
        public bool NoteRecordFound { get; set; }
    }
}
